         ...
         <section className="py-12 md:py-16 container mx-auto">
          <div className="mt-10 px-4 max-w-4xl mx-auto text-center md:tracking-wider font-medium">
            <p className="text-foreground">
              Fitness centar Maximus započeo je sa radom u septembru 2011. godine s ciljem da svojim članovima pruži moderno, ugodno i motivirajuće okruženje za trening. Tokom godina izgradili smo zajednicu ljudi koji dijele istu želju zdraviji, aktivniji i kvalitetniji način života.
            </p>
          </div>
